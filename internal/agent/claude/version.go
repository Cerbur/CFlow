// Semantic version parsing for the claude CLI identity probe. The
// captured 2.1.220 fixture prints `2.1.220 (Claude Code)`; the supported
// version range comes from the registry binding (">=1.0.0 <3.0.0" for
// the captured claude binding). Matching is a plain triple comparison;
...
// A pre-release suffix ("2.1.220-dev") matches its triple and is judged
// by that triple.
